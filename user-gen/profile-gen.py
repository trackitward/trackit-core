...
with open(f"../data/units/{student_number}.json", "r") as file:
    ...
    for course in data["data"]["course_data"]:
        course_obj = {
            ...
            "course_teacher": course["user_course"]["course_info"][
                "course_teacher"
            ],
            "course_total_units": course["user_course"]["course_info"][
                "course_total_units"
            ],
        }
...
headers = {
    ...
    "Accept": "text/plain",
    "API-PASS": "PASSTOAPI-TRACKER",
}
response = requests.post(
    "http://localhost:31475" + "/post/user/profile/create",
